export default function WhatWeDo() {
    return (
      <section className="py-16 bg-gray-100 mt-5 rounded-[20px]">
        <div className="container mx-auto px-3 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="flex flex-col p-4">
              <img src="/defaultImage.png" alt="Event Creation Simplified" className="w-full h-80 object-cover rounded-[20px] mb-4" />
            ...
            <div className="flex flex-col p-4">
              <img src="/defaultImage.png" alt="Real-Time Event Monitoring" className="w-full h-80 object-cover rounded-[20px] mb-4" />
            ...
            <div className="flex flex-col p-4">
              <img src="/defaultImage.png" alt="Smooth Ticket Validation" className="w-full h-80 object-cover rounded-[20px] mb-4" />
            ...
            <div className="flex flex-col p-4">
              <img src="/defaultImage.png" alt="Flexible Payout Options" className="w-full h-80 object-cover rounded-[20px] mb-4" />
