...
export default function HeroSection() {
  return (
    <section className="relative bg-cover bg-center min-h-screen xl:min-h-[130vh] flex flex-col md:pt-36 items-center justify-center md:justify-start text-white rounded-b-[20px]"
      style={{
    ...
    >
      ...
      <div className="z-10 text-center flex flex-col items-center mx-5 md:mx-10">
        <Image src="/hero-banner.svg" height={1000} width={1000} alt="Hero Banner" />
